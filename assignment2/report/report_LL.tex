...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/dynamic_taskqueue_chunk_comparison/dynamic_taskqueue_chunks_W1.pdf}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/dynamic_taskqueue_chunk_comparison/dynamic_taskqueue_chunks_W5.pdf}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/dynamic_workstealing_chunk_comparison/dynamic_workstealing_chunks_W1.pdf}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/dynamic_workstealing_chunk_comparison/dynamic_workstealing_chunks_W5.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/speedup_heatmaps_chunk_vs_threads/heatmap_speedup_dynamic_taskqueue_W1.pdf}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/speedup_heatmaps_chunk_vs_threads/heatmap_speedup_dynamic_workstealing_W1.pdf}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/speedup_heatmaps_chunk_vs_threads/heatmap_speedup_dynamic_taskqueue_W5.pdf}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/plots_sencha/speedup_heatmaps_chunk_vs_threads/heatmap_speedup_dynamic_workstealing_W5.pdf}
